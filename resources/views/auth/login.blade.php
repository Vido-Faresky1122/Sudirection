...
@section('content')
    <div class="relative min-h-screen bg-cover bg-center bg-fixed"
        style="background-image: url('{{ asset('assets/images/login-tower.png') }}');">
        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center justify-center gap-28 px-6     md:px-16 py-20 max-w-7xl mx-auto">
            ...
            <div class="max-w-lg text-center md:text-left">
                ...
                <p class="text-white text-lg leading-relaxed drop-shadow">
                    Sign in to continue your journey, revisit your favorite destinations, and discover new places that inspire your next adventure.
                    Your next direction is only a few steps away.
                </p>
            </div>
            ...
            <div class="w-full max-w-sm bg-white/10 backdrop-blur-2xl border border-white/25 rounded-[40px] p-8 shadow-2xl">
                ...
                <form method="GET" action="/auth/google">
                    <button type="submit"
                        class="btn-shimmer w-full flex items-center justify-center gap-3 py-3.5 rounded-full border-[1.5px] border-white/60 text-white font-bold hover:bg-white/10 transition">
